...
[].forEach.call(daysActive, function(i) {
	...
	Calendar.prototype.renderEvents = function (events, ele) {
		...
		events.forEach(function (ev) {
			...
			var span = createElement('a', '', ev.eventName,);
			span.href = '/clients'
...
!function () {
	var data = [
		...
		{eventName: 'Bowling Team', calendar: 'Other', color: 'green', eventTime: moment("2020-05-6")},
		{eventName: 'Teach Kids to Code', calendar: 'Other', color: 'green', eventTime: moment("2020-05-6")},
		{eventName: 'Startup Weekend', calendar: 'Other', color: 'green', eventTime: moment("2020-05-6")}
	];
